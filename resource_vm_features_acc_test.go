		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					// Pre-seeded MAC round-trips (normalised to uppercase by VirtualBox).
					resource.TestCheckResourceAttr(resourceName, "network_adapter.0.mac_address", "080027AB12CD"),
					resource.TestCheckResourceAttr(resourceName, "network_adapter.1.type", "nat"),
					// Unset MAC is generated by VirtualBox and still populated.
					resource.TestCheckResourceAttrSet(resourceName, "network_adapter.1.mac_address"),
				),
			},
		},
	})
...
resource "virtualbox_vm" "test" {
  ...
  network_adapter {
    ...
    nic_type     = "virtio"
    mac_address  = "080027AB12CD" # must be uppercase, matching VirtualBox's canonical form
  }
